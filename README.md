...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/PetterLaceda`; git checkout -b feat/community/PetterLaceda
